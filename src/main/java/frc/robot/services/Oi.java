...
public class Oi {
    ...
    private Oi() {
        ...
        intakeButton.and(cubeToggle.negate()).and(manualToggle.negate()).whileTrue(new IntakeConeSmartCommandGroup());
        intakeButton.and(cubeToggle).and(manualToggle.negate()).whileTrue(new IntakeCubeSmartCommandGroup());
