...
public class Oi
    ...
    public Oi(Drivebase drivebase, Collector collector)
    {
        ...
        intakeButton.and(coneToggle).and(manualToggle.negate()).onTrue(new Intakec);
        ...
        cubeScoreMid.whileTrue(new SetArmPositionCommand(Constants.ArmPos.SCORE_CONE_MID_SHOULDER, Constants.ArmPos.SCORE_CUBE_MID_WRIST));
