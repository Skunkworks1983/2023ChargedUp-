...
public class Constants extends CommandBase {
    ...
    public enum ArmPose {
        ...
        SUBSTATION_CUBE(43.68152, 174.73779, 4, false, Collector.CONE_COLLECT_AMP_THRESHOLD),
        SUBSTATION_CONE(42.56579, 156.46118, 1, true, Collector.CONE_COLLECT_AMP_THRESHOLD),
