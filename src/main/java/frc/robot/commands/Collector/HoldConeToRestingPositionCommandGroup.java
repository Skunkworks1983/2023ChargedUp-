...
public class HoldConeToRestingPositionCommandGroup extends ParallelCommandGroup {
    ...
    public static final Command ArmToHumanPlayer = new SetArmPositionCommand(Constants.Arm.SHOULDER_RESTING_ANGLE, Constants.ArmPos.CARRY_WRIST);

    public HoldConeToRestingPositionCommandGroup() {
        // TODO: Add your sequential commands in the super() call, e.g.
        //           super(new OpenClawCommand(), new MoveArmCommand());
        super(HoldCone, ArmToHumanPlayer);
    }
}