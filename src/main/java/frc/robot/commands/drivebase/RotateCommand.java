...
public class RotateCommand extends CommandBase
{
   ...
   private PIDController pidController = new PIDController(Constants.Drivebase.ANGLE_KP, 0.0042, Constants.Drivebase.ANGLE_KD,Constants.Drivebase.DRIVEBASE_KF);
