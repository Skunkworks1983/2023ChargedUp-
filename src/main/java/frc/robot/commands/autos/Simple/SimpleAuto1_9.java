...
public class SimpleAuto1_9 extends SequentialCommandGroup {
    public SimpleAuto1_9() {
        super(
                ...
                new ParallelRaceGroup(new DriveDistanceCommandGyro(Drivebase.GetDrivebase(), -11.5, Constants.Drivebase.DRIVEBASE_KF + .07), new SetArmPositionCommand(Constants.ArmPos.CARRY_SHOULDER, Constants.ArmPos.CARRY_WRIST))
        );
    }
}
